...
const Timeline = ({ navigation }) => {
  ...
  const spansView = spans
    ? spans.map((span) => (
        <View style={styles.container} key={span.span._id}>
          <Text
            ...
            onPress={() =>
              navigation.navigate("Episodes", {
                podcast_id: span.podcast._id,
                podcast_name: span.podcast.title,
              })
            }
          >
            {span.podcast.title}
          ...
          <Text>
            {timedisplay(span.span.start)} to {timedisplay(span.span.end)}{" "}
            {span.span.name}
          </Text>
        </View>
      ))
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>{spansView}</ScrollView>
    </View>
  );
};
